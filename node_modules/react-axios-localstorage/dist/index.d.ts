...
declare type AxiosCacheConfig = Partial<AxiosCacheConfigProps>;
interface AxiosCacheConfigProps {
    /**
...
interface AxiosCacheStatus<T> {
    data: T | undefined;
    error: AxiosError | unknown | undefined;
    loading: boolean;
}
declare const defaultConfig: AxiosCacheConfigProps;
/**
 ...
 */
declare const useAxiosCache: <T>(cacheKey: string, url: string, config?: Partial<AxiosCacheConfigProps> | undefined, axiosConfig?: AxiosRequestConfig<unknown> | undefined) => AxiosCacheStatus<T>;
/**
 ...
 */
declare const invalidateCache: (prefix?: string | undefined) => void;

export { AxiosCacheConfig, AxiosCacheConfigProps, AxiosCacheStatus, useAxiosCache as default, defaultConfig, invalidateCache, useAxiosCache };
